...
**processing** means any operation or set of operations which is performed on personal data or on sets of personal data, whether or not by automated means, such as collection, recording, organisation, structuring, storage, adaptation or alteration, retrieval, consultation, use, or disclosure.
...
The Government may control information and personal data of citizens and other persons in order to enable participation of citizens or the other persons where applicable on governance. This includes and is not limited to 
...
§ 2   
Processing confidential data, the further dissemination of which would clearly and substantially damage a person, their interests, or Liberland's interests, shall likewise be permissible only for the reasons listed in the second sentence of the previous paragraph.  
...
The Government shall utilize state-of-the-art information technology, set up and maintained according to the best available practices. The Government shall only use infrastructure produced by reliable manufacturers and installed and maintained by reputable parties, whether contracted or internal.

#### Art. 10: Free and Open Source Software

§ 1   
1) The Government shall prioritize the use of free software for on-premises applications wherever possible. If that is not feasible, it shall opt for an open-source solution. 
2) Only in exceptional cases, when free or open-source options are unavailable, clearly too expensive or burdensome to obtain, install, or maintain, or do not adhere to the best available practices, shall proprietary software be used. Cloud-based proprietary solutions shall be preferred before considering on-premises proprietary solutions.
...
§ 1  
1) Every Citizen and resident of Liberland has the right to request any piece of information the government controls, and the Government and any part thereof shall be bound to respond. 
...
§ 2  
1) Where the information contains personal data, the Government or the queried organ shall omit these from the answer, unless the answer also contains a statement of consent with the revealing signed by the data subject. 
2) Where omitting the personal data without context makes the information unintelligible, the Government or the queried organ shall attempt to make an explanation clarifying the issue.

...
2. Any Regulations established through a Referendum
...
3. The influence of the Referendum on the operations of the Senate shall be strictly confined to:
...
Initiating the General Referendum
...
A Proposal Fee which shall only apply to a Citizen Proposal, which shall be established based on the current needs by the system and specified in a Regulation; and
In conformity with Art. 79 Section 1/2 of the Constitution, they shall differ in ways how the voting requirement is tallied.


Drafting a Proposal
To initiate a Positive Referendum, the Citizen or the Congress shall draft a Proposal in its final form. The draft shall be prepared to a professional standard.
...
A comprehensive Regulatory Impact Assessment into the draft; and
A detailed Reasoning for each provision of the Proposal.
...
Quality control and Cancellation
...
Proposing a Public Veto
A Citizen may initiate a Negative Referendum in the form of a Public Veto utilizing the tools provided for this purpose by the Government.
...
Where applicable, the articles and the exact words which are to be repealed.
...
Public Veto shall cost the same amount in Referendum Free as a Citizen-originated General Referendum.


Proposing a Dismissal
...
Duration and conditions of a Negative Referendum
Upon submitting the Proposal, it becomes a Negative Referendum immediately.
...
Voting on a Negative Referendum
Voting on a Negative Referendum is conducted in the same system of electronic communication or, where the voting is done traditionally, using similar means as voting on a general Referendum; however, each Citizen has only one vote instead of their Voting Instrument balance.
Like when voting in a Positive Referendum, one can vote in multiple Negative Referenda running concurrently. Likewise, where one votes twice in one Negative Referendum, only the last voting attempt shall be counted such as when one votes in a General Referendum.


Voting Requirement for a Negative Referendum
...
Consequences of a successful Public Veto
...
Consequences of a successful  Dismissal
...
Government responsibility to establish the Blockchain system
...
Propose and vote in Referenda;
Monitor Referendum and Enactment Periods, including adjustments in duration;
Access historical Referendum data.
For each Referendum, the interface must display:
Referendum title;
Required documents, including RIA and Reasoning for Positive Referenda;
Classification of legislative instruments for Positive Referenda;
Identification of instruments or parts thereof for Amendments or Repeals;
Necessary details for Negative Referenda, such as Public Veto or Dismissal reasons;
Referendum origin;
Proposer's identity in Citizen Referenda;
Voting prerequisites;
Current vote tally; and
Active or past Referendum and Enactment Periods."
